...
public class ItemController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Map<String, Object>> createItem(@RequestBody @Valid ItemRequest request) {
    ...
    @PutMapping("/update")
    public ResponseEntity<Map<String, Object>> updateItem(@RequestBody @Valid ItemRequest request) {
